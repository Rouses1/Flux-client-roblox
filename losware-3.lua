...
local TABS = {"aimbot", "visuals", "misc", "autofarm"}
local tabBtns = {}
local tabFrames = {}
local activeTab = nil
...
for i, name in ipairs(TABS) do
	local btn = el("TextButton", sidebar, {
		...
		Position = UDim2.new(0, 0, 0, (i - 1) * 30 + 4),
...
switchTab = function(id)
	...
	for i, name in ipairs(TABS) do
		if name == id then
			accentLine.Position = UDim2.new(0, 0, 0, (i - 1) * 30 + 8)
			break
		end
	end
end
...
do
	...
	addSlider(t, "Hitbox", "HitboxScale", 1, 6, "%.1f", 11)
end
