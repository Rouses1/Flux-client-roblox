...
if typeof(gethui) == "function" then
    ...
    _guiParent = ok and cg or LocalPlayer:WaitForChild("PlayerGui")
end
...
-- Open button (bottom left, mobile friendly)
local OpenBtn = make("TextButton", {
    Size             = ud2(56,56),
    Position         = ud2s(0,14,1,-74),
...
make("UICorner", {CornerRadius = UDim.new(0,14)}, OpenBtn)
...
local function makeScrollFrame(parent)
    ...
    make("UIPadding", {PaddingLeft=px(10), PaddingRight=px(10), PaddingTop=px(6)}, sf)
...
local function toggleGui()
    ...
    OpenBtn.Text = guiOpen and "✕" or "lw"
end

-- All possible event types for Delta mobile compatibility
OpenBtn.MouseButton1Click:Connect(toggleGui)
OpenBtn.Activated:Connect(toggleGui)
OpenBtn.TouchTap:Connect(toggleGui)

CloseBtn.MouseButton1Click:Connect(toggleGui)
CloseBtn.Activated:Connect(toggleGui)
CloseBtn.TouchTap:Connect(toggleGui)
